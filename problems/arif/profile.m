...
configs = [
    ...
    'xlabel','A','ylabel','C_f R_e^{1/2}','title','Figure 3: Skin friction vs A', 'showOutliers', plotOutliers, ...
    ...
    'xlabel','A','ylabel','Nu R_e^{-1/2}','title','Figure 4: Nusselt vs A', 'showOutliers', plotOutliers, ...
